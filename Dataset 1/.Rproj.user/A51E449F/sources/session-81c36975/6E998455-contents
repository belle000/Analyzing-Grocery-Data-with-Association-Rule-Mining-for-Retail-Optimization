...
mixed_transactions_eclat <- basketize(mixed_transactions_cleaned, "mixed_baskets.csv")

# Basketizing for Only Normal Transactions
only_normal_transactions_eclat <- basketize(only_normal_transactions_cleaned, "only_normal_baskets.csv")

# Basketizing for Only Bulk Transactions
only_bulk_transactions_eclat <- basketize(only_bulk_transactions_cleaned, "only_bulk_baskets.csv")


# APPLYING THE ECLAT ALGORITHM
#===================================================================================================================

# Step 1: Eclat Algorithm for Mixed Transactions
frequent_itemsets_mixed <- eclat(mixed_transactions_eclat, parameter = list(supp = 0.02))
inspect(frequent_itemsets_mixed)

rules_mixed <- ruleInduction(frequent_itemsets_mixed, mixed_transactions_eclat, confidence = 0.3)
...
frequent_itemsets_only_normal <- eclat(only_normal_transactions_eclat, parameter = list(supp = 0.02))
inspect(frequent_itemsets_only_normal)

rules_only_normal <- ruleInduction(frequent_itemsets_only_normal, only_normal_transactions_eclat, confidence = 0.3)
inspect(rules_only_normal[1:5])

# Check how many rules are generated for Only Normal Transactions
cat("Number of rules for Only Normal Transactions:", length(rules_only_normal), "\n")

# Sort and inspect rules for Only Normal Transactions
rules_only_normal_sorted <- sort(rules_only_normal, by = "lift", decreasing = TRUE)
inspect(rules_only_normal_sorted)

#===================================================================================================================

# Step 3: Eclat Algorithm for Only Bulk Transactions
frequent_itemsets_only_bulk <- eclat(only_bulk_transactions_eclat, parameter = list(supp = 0.01))
inspect(frequent_itemsets_only_bulk)

# Generate rules for Only Bulk Transactions
rules_only_bulk <- ruleInduction(frequent_itemsets_only_bulk, only_bulk_transactions_eclat, confidence = 0.3)

# Check how many rules are generated for Only Bulk Transactions
cat("Number of rules for Only Bulk Transactions:", length(rules_only_bulk), "\n")

# Sort and inspect rules for Only Normal Transactions
rules_only_bulk_sorted <- sort(rules_only_bulk, by = "lift", decreasing = TRUE)
