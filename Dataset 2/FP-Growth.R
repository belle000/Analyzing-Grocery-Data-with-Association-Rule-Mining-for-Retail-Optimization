...
# Uncomment dl terus run lalu comment lagi
...
# Run FPGrowth algorithm for both year
basket_rules_fp_2014 <- fim4r(
  txn_2014, method = "fpgrowth", target = "rules", supp = 0.002, conf = 0.5
)
basket_rules_fp_2015 <- fim4r(
  txn_2015, method = "fpgrowth", target = "rules", supp = 0.002, conf = 0.5
)

# Print number of rules and display the top rules sorted by lift
cat("Number of rules for year 2014:", length(basket_rules_fp_2014), "\n")
rules_sorted_by_lift_2014 <- sort(basket_rules_fp_2014, by = "lift", decreasing = TRUE)
inspect(rules_sorted_by_lift_2014)  

cat("Number of rules for year 2015:", length(basket_rules_fp_2015), "\n")
rules_sorted_by_lift_2015 <- sort(basket_rules_fp_2015, by = "lift", decreasing = TRUE)
inspect(rules_sorted_by_lift_2015)  

# Plot rules 
plot(basket_rules_fp_2014, measure = c("support", "confidence"), shading = "lift", main = "FP-Growth Rules for Year 2014")
plot(basket_rules_fp_2015, measure = c("support", "confidence"), shading = "lift", main = "FP-Growth Rules for Year 2015")

plot(basket_rules_fp_2014, method = "grouped", main = "Grouped Rules for 2014")
plot(basket_rules_fp_2015, method = "grouped", main = "Grouped Rules for 2015")

plot(basket_rules_fp_2014, method = "graph", main = "Graph of Rules for 2014")
plot(basket_rules_fp_2015, method = "graph", main = "Graph of Rules for 2015")
